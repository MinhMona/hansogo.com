    ...
    public partial class outstock_finish : System.Web.UI.Page
    {
                ...
                if (id > 0)
                {
                    ...
                    if (os != null)
                    {
                        ...
                        if (ops.Count > 0)
                        {
                            ...
                            html.Append("<th style=\"mso-number-format:'\\@'\">Mã kiện</th>");
                            ...
                            htmlPrint.Append("               <th style=\"mso-number-format:'\\@'\" style=\"color:#000\">Mã kiện</th>");
                            ...
                            foreach (var o in ops)
                            {
                                ...
                                var listsp = FeeSupportController.GetAllByMainOrderID(o.OrderID);
                                bool isPay = o.isPay;
                                int Count = 1;
                                int temp = 1;
                                ...
                                foreach (var p in listpackages)
                                {
                                    if (Count == 1)
                                    {
                                        ...
                                        html.Append("<td rowspan=\"" + listpackages.Count + "\"><span class=\"red-text font-weight-700\">" + string.Format("{0:N0}", o.ToTalPriceVND) + " VNĐ</span></td>");

                                        html.Append("<td rowspan=\"" + listpackages.Count + "\"><span class=\"red-text font-weight-700\">" + string.Format("{0:N0}", o.ToTalPriceVND - o.totalMustPay) + " VNĐ</span></td>");
                                        ...
                                        html.Append("<td rowspan=\"" + listpackages.Count + "\">");
                                        if (listsp.Count > 0)
                                        {
                                            foreach (var item in listsp)
                                            {
                                                html.Append("<tr class=\"feesupport fee-versionnew\" data-feesupportid=\"" + item.ID + "\">");
                                                html.Append("<td colspan=\"3\"><span>Phụ phí:   " + item.SupportName + "</span></td>");
                                                html.Append("<td><span class=\"red-text font-weight-700\">" + string.Format("{0:N0}", Convert.ToDouble(item.SupportInfoVND)) + " VNĐ</span></td>");
                                                html.Append("</tr>");
                                            }
                                        }
                                        html.Append("</td>");
                                ...
                                foreach (var p in listpackages)
                                {
                                    if (temp == 1)
                                    {
                                        ...
                                        htmlPrint.Append("               <td style=\"mso-number-format:'\\@'\" >" + p.packagecode + "</td>");
                                        ...
                                        htmlPrint.Append("<td rowspan=\"" + listpackages.Count + "\">");
                                        if (listsp.Count > 0)
                                        {
                                            foreach (var item in listsp)
                                            {
                                                htmlPrint.Append("<tr>");
                                                htmlPrint.Append("<td colspan=\"6\"><span>Phụ phí:   " + item.SupportName + "</span></td>");
                                                htmlPrint.Append("<td><span class=\"red-text font-weight-700\">" + string.Format("{0:N0}", Convert.ToDouble(item.SupportInfoVND)) + " VNĐ</span></td>");
                                                htmlPrint.Append("</tr>");
                                            }
                                        }
                                        htmlPrint.Append("</td>");
                            ...
                            html.Append("<tbody>");
                            html.Append("<tr>");
                            html.Append("<td colspan=\"10\"><span class=\"black-text font-weight-500\">Tổng cân nặng</span></td>");
                            html.Append("<td><span class=\"black-text font-weight-600\">" + totalWeight + " KG</span></td>");
                            html.Append("</tr>");
                            html.Append("<tr>");
                            html.Append("<td colspan=\"10\"><span class=\"black-text font-weight-500\">Tổng tiền lưu kho</span></td>");
                            html.Append("<td><span class=\"black-text font-weight-600\">" + string.Format("{0:N0}", totalluukho) + " VNĐ</span></td>");
                            html.Append("</tr>");
                            html.Append("<tr>");
                            html.Append("<td colspan=\"10\"><span class=\"black-text font-weight-500\">Tiền cần thanh toán</span></td>");
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                ...
                html += "   <div class=\"top\">";
                //html += "       <div class=\"left\">";
                //html += "           <span class=\"company-info\" style=\"font-size: 14px;\" >HANSOGO</span>";
                //html += "           <span class=\"company-info\">Địa chỉ: " + address + "</span>";
                //html += "           <span class=\"company-info\">Website: HANSOGO.COM</span>";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            //StrExport.Append(content);
            //StrExport.Append("</div></body></html>");
            //string strFile = "chi_tiet_phien_xuat_kho.xls";

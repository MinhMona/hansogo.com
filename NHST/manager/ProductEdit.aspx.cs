        ...
        public void Loaddata()
        {
            ...
            if (id > 0)
            {
                ...
                if (o != null)
                {
                    ...
                    //    }
                    //}
                    imgLogoBefore.ImageUrl = o.image_origin;
                    txtTitleOrigin.Text = o.title_origin;
                    pLink.Text = o.link_origin;
                    double price = 0;
            ...
            if (id > 0)
            {
                ...
                if (o != null)
                {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGmail_new( AccountController.GetByID(Convert.ToInt32(od.UID)).Email,
                                            "Thông báo tại HANSOGO", "Đơn hàng: " + MainOrderID + " có sản phẩm bị hết hàng.", "");
                                    }
                                    catch
                                    {
                    ...
                    if (imgLogo.PostedFiles.Count > 0)
                    {
                        ...
                        IMG = imgLogoBefore.ImageUrl;
                    string link = pLink.Text;
                    OrderController.UpdateLinkLinkIMG(id, link, IMG);
                }
            }

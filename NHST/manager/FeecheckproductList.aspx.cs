        ...
        public void pagingall(List<tbl_FeeCheckProduct> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    string type = "";
                    if (item.Type == 1)
                        type = "<span class=\"badge red darken-2 white-text border-radius-2\">Dưới 10 yên</span>";
                    else
                        type = "<span class=\"badge blue darken-2 white-text border-radius-2\">Trên 10 yên</span>";
                    hcm.Append("<tr>");

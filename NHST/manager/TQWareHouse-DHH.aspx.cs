                                ...
                                if (mainorder != null)
                                {
                                    ...
                                    if (smallpackages.Count > 0)
                                    {
                                        ...
                                        if (isChuaVekhoTQ == false)
                                        {
                                            ...
                                            //                     {
                                            //                         NotificationsController.Inser(acc.ID, acc.Username, MainorderID, "Hàng của đơn hàng " + MainorderID + " đã về kho JP.",
                                            //1, currentDate, username, true);
                                            //                     }
                                            //                     else
                                            //                     {
                                            //                         NotificationsController.Inser(acc.ID, acc.Username, MainorderID, "Hàng của đơn hàng TMĐT " + MainorderID + " đã về kho JP.",
                                            ...
                                            //                             "Thông báo tại HANSOGO.", "Hàng của đơn hàng " + MainorderID + " đã về kho JP.", "");
                                            //                     }
                                            //                     catch { }
                                            //                 }
                                            //             }
                ...
                else
                {
                    ...
                    if (mainorder != null)
                    {
                        ...
                        double TotalPriceVND = FeeShipCN + FeeBuyPro + FeeWeight + IsCheckProductPrice + IsPackedPrice
                                                     + IsFastDeliveryPrice + isfastprice + pricenvd + InsuranceMoney + TotalFeeSupport;
                        ...
                        if (accChangeData != null)
                        {
                            if (status == 2)
                            {
                                HistoryOrderChangeController.Insert(mainorder.ID, accChangeData.ID, accChangeData.Username, accChangeData.Username +
                                               ...
                                               + "</strong> của đơn hàng ID là: " + mainorder.ID + ", là: Đã về kho JP", 8, currentDate);
                            }
                            ...
                            if (checkIsChinaCome == true)
                            {
                                ...
                                HistoryOrderChangeController.Insert(mainorder.ID, accChangeData.ID, accChangeData.Username, accChangeData.Username +
                                                   " đã đổi trạng thái đơn hàng ID là: " + mainorder.ID + ", là: Đã về kho JP", 8, currentDate);
                            }
                        }

            ...
            if (!string.IsNullOrEmpty(rp_vnd.Text))
            {
                ...
                if (u != null)
                {
                    ...
                    if (money > 0)
                    {
                        ...
                        {
                            PJUtils.ShowMessageBoxSwAlert("Số tiền yên muốn rút đang nhiều hơn ví yên!", "e", true, Page);
                        }
                    }
                    else
                    {
                        PJUtils.ShowMessageBoxSwAlert("Vui lòng nhập số tiền yên muốn rút lớn hơn 0.", "e", true, Page);
                    }
                }
                else
                {

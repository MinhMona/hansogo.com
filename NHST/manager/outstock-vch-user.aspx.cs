...
namespace NHST.manager
{
    public partial class outstock_vch_user : System.Web.UI.Page
    {
                            ...
                            if (listID.Length - 1 > 0)
                            {
                                ...
                                for (int i = 0; i < lID.Count; i++)
                                {
                                    ...
                                    if (t != null)
                                    {
                                        ...
                                        TransportationOrderNewController.UpdateRequestOutStock(t.ID, 5, note, currentDate, shippingtype, totalPriceVND.ToString());
                                    }
                                }
                                #endregion
        ...
        //                        double totalWeightPriceVND = 0;
        //                        double totalWeightPriceVND_1 = 0;
        //                        double totalWeightPriceCYN = 0;
        ...
        //                                //    if (acc.FeeTQVNPerWeight.ToFloat(0) > 0)
        //                                //    {
        //                                //        totalWeightPriceVND = Convert.ToDouble(acc.FeeTQVNPerWeight) * totalWeightSingle;
        //                                //    }
        //                                //}
        //                                //else
        //                                //{
        ...
        //                                //                foreach (var f in fee)
        //                                //                {
        //                                //                    if (totalWeightSingle > f.WeightFrom && totalWeightSingle <= f.WeightTo)
        //                                //                    {
        //                                //                        totalWeightPriceVND = Convert.ToDouble(f.Price) * totalWeightSingle;
        //                                //                        break;
        //                                //                    }
        //                                //                }
        //                                //            }
        ...
        //                                //    }
        //                                //}
        //                                //double totalPrice1Barcode = 0;
        //                                //totalPrice1Barcode = totalWeightPriceVND + feeOutStockVND + addfeeVND + sensorVND;
        //                                //// update Total price
        //                                //TransportationOrderNewController.UpdateTotalPrice(ID, Convert.ToString(totalPrice1Barcode));
        //                            }
        //                        }
        ...
        //                        string[] IDTrans = listpack.Split('|');
        //                        if (IDTrans.Length - 1 > 0)
        //                        {
        //                            for (int i = 0; i < IDTrans.Length - 1; i++)
        //                            {
        //                                int ID = IDTrans[i].ToInt(0);
        ...
        //                                                        if (item.TotalWeight > f.WeightFrom && item.TotalWeight <= f.WeightTo)
        //                                                        {
        //                                                            totalWeightPriceVND_1 = Convert.ToDouble(f.Price) * totalWeightSingle;
        //                                                            break;
        //                                                        }
        //                                                    }
        //                                                }
        ...
        //                                    }
        //                                    double totalPrice1Barcode = 0;
        //                                    totalPrice1Barcode = totalWeightPriceVND_1 + feeOutStockVND + addfeeVND + sensorVND;
        //                                    // update Total price
        //                                    TransportationOrderNewController.UpdateTotalPrice(ID, Convert.ToString(totalPrice1Barcode));

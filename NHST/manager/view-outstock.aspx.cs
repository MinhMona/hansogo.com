        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (ac.RoleID != 0 && ac.RoleID != 7 && ac.RoleID != 5)
                        Response.Redirect("/trang-chu");
                }
                LoadData();
            }
                ...
                if (id > 0)
                {
                    ...
                    if (os != null)
                    {
                        ...
                        if (ops.Count > 0)
                        {
                            ...
                            htmlout += "           <span class=\"company-info\" style=\"font-size: 14px;\" >HANSOGO</span>";
                            htmlout += "           <span class=\"company-info\">Địa chỉ: " + address + "</span>";
                            htmlout += "           <span class=\"company-info\">Website: HANSOGO.COM</span>";

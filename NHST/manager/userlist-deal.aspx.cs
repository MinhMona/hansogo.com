...
{
    public partial class userlist_deal : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                var la = AccountController.GetAll_ViewUserListExcel_Dealer("", id).Where(u => u.RoleID == 1).ToList();
        ...
        public void LoadData()
        {
            ...
            if (id > 0)
            {
                ...
                var la = AccountController.GetListUserBySQL_listDealer(id, search, searchid, page, 10);
                int total = AccountController.GetTotalUser_ListDeal(id, search, searchid);
                pagingall(la, total);
            }
        }
        ...
        public void pagingall(List<View_UserList> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = 0; i < acs.Count; i++)
                {
                    ...
                    hcm.Append("<li><a href=\"AddRequestRechargeCYN.aspx?i=" + item.ID + "&pre=" + Page + "\">Nạp Yên</a></li>");
                    hcm.Append("</ul>");
                    ...
                    hcm.Append("<li><a href=\"addRefund.aspx?i=" + item.ID.ToString() + "&pre=" + Page + "\">Rút Yên</a></li>");
                    hcm.Append("</ul>");

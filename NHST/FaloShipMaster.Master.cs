...
namespace NHST
{
    public partial class FaloShipMaster : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrLogoFT.Text = "  <img src=\"" + confi.LogoIMG + "\" alt=\"\">";
                ...
                ltrTygia.Text += "<p class=\"text-intro\">Tỉ giá:  <span> 1¥ = " + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + " </span></p>";
                ltrEmail.Text += "<a href=\"mailto:" + email + "\" class=\"text-intro\">Email: <span>" + email + "</span></a>";
            ...
            if (Session["userLoginSystem"] != null)
            {
                ...
                if (acc != null)
                {
                    ...
                    ltrLogin.Text += "<a href=\"/thong-tin-nguoi-dung\" class=\"user-menu-logo\"><img src=\"/App_Themes/FaShip/images/logo.png\" alt=\"\"></a>";

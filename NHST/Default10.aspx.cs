    ...
    public partial class Default7 : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (services.Count > 0)
            {
                ...
                foreach (var item in services)
                {
                    ...
                    ltrService.Text += "<a href=\"\">";
                    ltrService.Text += "<div class=\"bg-"+ stt + " content wow fadeInUp\" data-wow-delay=\".2s\" data-wow-duration=\"1s\">";
                    ltrService.Text += "<div class=\"img-dv\">";
            ...
            if (steps.Count > 0)
            {
                ...
                foreach (var item in steps)
                {
                    ...
                    //if (count == 1)
                    //{
                    //    ltrStep1.Text += "<li data-tab=\"js-" + count + "\" class=\"active\">" + item.StepName + "<i class=\"fa fa-long-arrow-right\"></i></li>";
                    //}
                    //else
                    //{
                    //    ltrStep1.Text += "<li data-tab=\"js-" + count + "\">" + item.StepName + "<i class=\"fa fa-long-arrow-right\"></i></li>";
                    //}
                    ...
                    //ltrStep2.Text += "<img src=\"/App_Themes/TrungVietOrder/images/img-hd.png\" alt=\"\">";
                    //ltrStep2.Text += "</div>";
            ...
            if (confi != null)
            {
                ...
                ltrAddress.Text += "<span class=\"text-ct\">Địa chỉ <br/><i>" + confi.Address + "</i></span>";
        ...
        public void SearchPage(string page, string text)
        {
            ...
            if (page == "tmall")
            {
                ...
                linkgo = "https://www.mercari.com/jp/search/?keyword=" + textsearch_tmall + "&type=p&vmarket=&spm=875.7931836%2FB.a2227oh.d100&from=mallfp..pc_1_searchbutton";
            }
            else if (page == "taobao")
            {
                string a = text;
                ...
                linkgo = "https://auctions.yahoo.co.jp/search/search?p=" + textsearch_taobao + "&navigator=all&_input_charset=&spm=a21bp.7806943.20151106.1";
            ...
            else if (page == "1688")
            {
                ...
                linkgo = "https://search.rakuten.co.jp/search/mall/" + textsearch_1688 + "&button_click=top&earseDirect=false&n=y";
            }

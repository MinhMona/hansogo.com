    ...
    public partial class danh_sach_don_hang : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (obj_user != null)
            {
                ...
                double Tongtienhangdonhuy = 0;
                double Tongtienhangdonhoanthanh = 0;
                ...
                if (tos.Count > 0)
                {
                    var orderstt0 = MainOrderController.GetCountStatus(UID, 0, t);//tos.Where(od => od.Status == 0).ToList();
                    var orderstt2 = MainOrderController.GetCountStatus(UID, 2, t);//tos.Where(od => od.Status == 2).ToList();
                    var orderstt5 = MainOrderController.GetCountStatus(UID, 5, t);//tos.Where(od => od.Status == 5).ToList();
                    var orderstt6 = MainOrderController.GetCountStatus(UID, 6, t);//tos.Where(od => od.Status == 6).ToList();
                    var orderstt7 = MainOrderController.GetCountStatus(UID, 7, t); //tos.Where(od => od.Status == 7).ToList();
                    var orderstt10 = MainOrderController.GetCountStatus(UID, 10, t);//tos.Where(od => od.Status == 10).ToList();

                    var orderstt1 = MainOrderController.GetCountStatus(UID, 1, t); //tos.Where(od => od.Status == 7).ToList();
                    var orderstt9 = MainOrderController.GetCountStatus(UID, 9, t);//tos.Where(od => od.Status == 10).ToList();
                    ...
                    var Tongtienhangdondacoc = MainOrderController.GetTotalPrice(UID, 0, "TotalPriceVND", t);
                    ...
                    Tongtienhangdonhuy = MainOrderController.GetTotalPrice(UID, 1, "TotalPriceVND", t);

                    Tongtienhangdonhoanthanh = MainOrderController.GetTotalPrice(UID, 10, "TotalPriceVND", t);

                    tongtienhangchuagiao = Tongtienhangdondacoc + Tongtienhangchovekhotq + Tongtienhangdavekhotq + Tongtienhangdangokhovn;
                    #endregion

                    order_stt0 = orderstt0;
                    order_stt2 = orderstt2;
                    order_stt5 = orderstt5;
                    order_stt6 = orderstt6;
                    order_stt7 = orderstt7;
                    order_stt10 = orderstt10;

                    order_stt1 = orderstt1;
                    order_stt9 = orderstt9;

                    tongsodonhang = MainOrderController.GetCountStatus(UID, -1, t); //tos.Count;
                    ...
                    ltrDonhoanthanh.Text = string.Format("{0:N0}", Tongtienhangdonhoanthanh).Replace(",", ".");
                    ltrDonhuy.Text = string.Format("{0:N0}", Tongtienhangdonhuy).Replace(",", ".");
                    ...
                    ltrOrderStatus1.Text = string.Format("{0:N0}", order_stt1).Replace(",", ".");
                    ltrOrderStatus9.Text = string.Format("{0:N0}", order_stt9).Replace(",", ".");
                                                    ...
                                                    foreach (var admin in admins)
                                                    {
                                                        try
                                                        {
                                                            PJUtils.SendMailGmail_new( admin.Email,
                                                                "Thông báo tại HANSOGO.", "Đơn hàng " + o.ID + " đã được đặt cọc.", "");
                                                        }
                                                        catch { }
                                                    }
                                                }
                                        ...
                                        if (setNoti.IsSentEmailAdmin == true)
                                        {
                                            ...
                                            if (admins.Count > 0)
                                            {
                                                foreach (var admin in admins)
                                                {
                                                    ...
                                                    {
                                                        PJUtils.SendMailGmail_new( admin.Email,
                                                            "Thông báo tại HANSOGO.", "Đơn hàng " + item.MainOrderID + " đã yêu cầu giao hàng.", "");
                                                    }
                                                    catch { }
                                                }
                                            }
                                    ...
                                    if (setNoti.IsSentEmailAdmin == true)
                                    {
                                        ...
                                        if (admins.Count > 0)
                                        {
                                            foreach (var admin in admins)
                                            {
                                                ...
                                                {
                                                    PJUtils.SendMailGmail_new( admin.Email,
                                                        "Thông báo tại HANSOGO.", "Đơn hàng " + o.ID + " đã được thanh toán.", "");
                                                }
                                                catch { }
                                            }
                                        }

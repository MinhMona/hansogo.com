...
namespace NHST.Controllers
{
    public class AccountController
    {
        ...
        public static int GetTotalUser_List(string searchName, string searchid, string searchphone)
        {
            var sql = @"select Total=COUNT(*) ";
            sql += "from View_UserList ";
            sql += "where  RoleID=1 ";
        ...
        public static List<View_UserList> GetListUserBySQL_list(string searchname, string searchid, string searchphone, int pageIndex, int pageSize)
        {
            var sql = @"select* ";
            sql += "from View_UserList ";

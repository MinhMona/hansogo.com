<%@ Page Title="Nạp tiền yên app" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="rut-tien-te-app.aspx.cs" Inherits="NHST.rut_tien_te_app" %>
            ...
            <asp:Panel ID="pnMobile" runat="server" Visible="false">
                <div class="page-body">
                    <div class="all donhang hoante">
                        <h2 class="title_page">NẠP TIỀN yên</h2>
                        <div class="content_page">
                            <p class="title_onpage">YÊU CẦU NẠP TIỀN yên</p>
                            <p class="user">

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function CheckLink(link) {
            ...
            $.ajax({
                type: "POST",
                url: "/manager/tao-don-hang-khac.aspx/checkLinkOrder",
                data: "{listLink:'" + link + "',userName:'" + userName + "'}",
                ...
                success: function (msg) {
                    ...
                    if (data != "null") {
                        ...
                        if (check == true) {
                            ...
                            swal({
                                title: "Thông báo",
                                text: "Sản phẩm đã được lên đơn với khách hàng này, bạn có muốn tiếp tục tạo đơn này ?",
                                type: "warning",
                                ...
                                function (isConfirm) {
                                    ...
                                    if (isConfirm) {
                                        //swal("Thông báo", "Tạo đơn thành công", "success");
            ...
            if ($(".product-item").length > 0) {
                ...
                if (check == true) {
                    ...
                    $(".product-item").each(function () {
                        ...
                        link += productlink +"ϟ";
                        html += productlink + "ϟ" + productname + "ϟ" + productsizecolor + "ϟ" + productquantity + "ϟ" + productrequest
                            + "ϟ" + image + "〄";
                    });

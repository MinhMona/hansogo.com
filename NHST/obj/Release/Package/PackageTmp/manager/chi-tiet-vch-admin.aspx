<%@ Page Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="chi-tiet-vch-admin.aspx.cs" Inherits="NHST.manager.chi_tiet_vch_admin" %>
                    ...
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            <div class="search-name input-field  col s12">
                              <%--  <asp:TextBox runat="server" ID="rp_username" type="text" class="validate"></asp:TextBox>

    ...
    <div id="main" class="">
                            ...
                            <div id="order-list" class="section scrollspy order-list">
                                ...
                                <div class="order-item">
                                    <div class="left-info">
                                        ...
                                        <a href="#modalEditFee" class="btn modal-trigger" data-position="top"> <i class="material-icons">add</i><span>THÊM SẢN PHẨM</span></a>
                                ...
                                <div class="fee-wrap">
                                    <ul class="list-total">
                                        ...
                                        <li><span class="lbl">Phí tùy chọn</span><span class="value"><asp:Label ID="lblAllFee" runat="server" Text="0"></asp:Label>
                                            VNĐ</span></li>
                                        <li><span class="lbl">Phí vận chuyển JP - VN</span><span class="value"><asp:Label ID="lblFeeTQVN" runat="server" Text="0"></asp:Label>
                                            VNĐ</span></li>
     ...
     <div id="modalEditFee" class="modal modal-fixed-footer">
        <div class="modal-hd">
            ...
            <h4 class="no-margin center-align">THÊM SẢN PHẨM</h4>
        </div>
        <div class="modal-bd">
            <div class="row">
                <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtProductName" type="text" class="validate" data-type="text-only" value=" "
                        ></asp:TextBox>
                    <label for="edit_from_warehouse">Tên sản phẩm</label>
                </div>
                <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtProperty" type="text" class="validate" data-type="text-only" value=" "
                        ></asp:TextBox>
                    <label for="edit_to_warehouse">Thuộc tính</label>
                </div>
                <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtLink" type="text" class="validate" data-type="text-only" value=" "></asp:TextBox>
                    <label for="edit_weight_from">Link sản phẩm</label>
                </div>
                <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtPriceProduct" type="text" class="validate" data-type="text-only" value=" "></asp:TextBox>
                    <label for="edit_weight_to">Đơn giá</label>
                </div>

                 <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtQuantity" type="number" class="validate" data-type="text-only" value=" "></asp:TextBox>
                    <label for="edit_weight_to">Số lượng</label>
                </div>

                <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtNoteProduct" type="text" class="validate" data-type="text-only" value=" "></asp:TextBox>
                    <label for="edit_weight_to">Ghi chú</label>
                </div>

                 <div class="input-field col s12 ">
                                            <div class="left-fixed">
                                                <p class="txt">Ảnh sản phẩm</p>
                                            </div>
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
        ...
        <div class="modal-ft">
            <div class="ft-wrap center-align">
                <asp:Button ID="btnAddProduct" runat="server" OnClick="btnAddProduct_Click" UseSubmitBehavior="false" class="white-text btn  mr-2" Text="Lưu"></asp:Button>

...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                        ...
                        <div class="select-bao">
                            <div class="input-field inline">
                               <%-- <input placeholder="Nhập mã đơn hàng" id="txtOrderID" type="text"
                                ...
                                <asp:TextBox ID="txtOrderID" runat="server" type="text" placeholder="Nhập mã đơn hàng" class="validate autocomplete no-margin"></asp:TextBox>
                            </div>
                            <div class="input-field inline">
                            ...
                            <a href="javascript:;" class="btn modal-trigger waves-effect" style="background-color:green; margin-left:2px" onclick="btnXuatExcel()" >Xuất excel</a>
                        </div>
    ...
    <asp:Button ID="btn_Excel" runat="server" OnClick="btn_ExportExcel" Style="display: none" />
    ...
    <script type="text/javascript">
                            ...
                            else if (ret == "notuser")
                            {
                                ...
                                if (isExist == false) {
                                    if (check == false) {
                                        ...
                                        if (status == 1) {
                                            html += "<td><span class=\"white-text badge red darken-2\">Chưa về kho JP</span></td>";
                                        }
                                        else if (status == 2) {
                                            html += "<td><span class=\"white-text badge orange darken-2\">Đã về kho JP</span></td>";
                                        }
                                        else if (status == 3) {
        ...
        function getpackagebyoID() {
            ...
            if (!isEmpty($('#<%=txtOrderID.ClientID%>').val()))
                orderid = $('#<%=txtOrderID.ClientID%>').val();

                                                    ...
                                                    <div class="table table-info   ">
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>Đơn hàng đã thanh toán</td>
                                                                    <td><span
                                                                        class="teal-text text-darken-4 font-weight-700">
                                                                        <asp:Literal ID="ltrOrderStatus9" runat="server"></asp:Literal></span>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>Đơn hàng đã hủy</td>
                                                                    <td><span
                                                                        class="teal-text text-darken-4 font-weight-700">
                                                                        <asp:Literal ID="ltrOrderStatus1" runat="server"></asp:Literal></span>
                                                                    </td>
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                    <td>Tổng tiền hàng đã hoàn thành</td>
                                                                    <td><span
                                                                        class="teal-text text-darken-4 font-weight-700">
                                                                        <asp:Literal ID="ltrDonhoanthanh" runat="server"></asp:Literal>
                                                                        VNĐ</span></td>
                                                                </tr>

                                                                 <tr>
                                                                    <td>Tổng tiền hàng đơn hủy</td>
                                                                    <td><span
                                                                        class="teal-text text-darken-4 font-weight-700">
                                                                        <asp:Literal ID="ltrDonhuy" runat="server"></asp:Literal>
                                                                        VNĐ</span></td>
                                                                </tr>

        ...
        public void LoadData()
        {
            ...
            if (services.Count > 0)
            {
                foreach (var item in services)
                {
                    ...
                    ltrService.Text += "</div>";
                    ltrService.Text += "<div class=\"title-intro\">" + item.ServiceName + "</div>";
                    ltrService.Text += "<p class=\"desc-intro\">" + item.ServiceContent + "</p>";
                    if (!string.IsNullOrEmpty(item.ServiceLink))
                        ltrService.Text += "<p class=\"text-center\"><a href=\"" + item.ServiceLink + "\" class=\"btn btn-detail\">Xem thêm <i class=\"fa fa-long-arrow-right\"></i></a></p>";
                    ltrService.Text += "</div>";
                    ltrService.Text += "</div>";
                }
            }

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="form-row marbot2">
                                        <div class="itemaddmore  border-bottom">
                                            <div class="itemyeuau row-item">
                                                <div class="rowhalf">
                                                    <div class="label-field">Giá tiền (yên):</div>
                                    ...
                                    <div class="form-row marbot2">
                                        ...
                                        <p style="color: #000; font-weight: bold;">
                                            Chuyển khoản để lại nội dung: username - tổng số yên.
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function addMoreRequest() {
            ...
            html += "<div class=\"rowhalf \"> <div class=\"label-field\">Giá tiền (yên):</div><div class=\"textbox-field\"><input class=\"txtDesc2 form-control border-ra-bg\" oninput=\"sumtotalprice()\" value=\"0\"/></div></div>";

...
namespace NHST
{
    public partial class TKExpressMaster : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrTop.Text += "<li>Tỉ giá: 1¥ = <span>" + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + " </span></li>";
                ltrTop.Text += "<li>Email: <span><a href=\"mailto:" + email + "\">" + email + "</a></span></li>";
                ltrTop.Text += "<li>Hotline: <span><a href=\"tel:" + hotline + "\">" + hotline + "</a></span></li>";
                ltrTop.Text += "<li>Giờ hoạt động: <span>" + timework + "</span></li>";

...
namespace NHST
{
    public partial class HansogoMaster : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrTyGia.Text += "<p>Tỷ giá: 1¥ = " + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + " VNĐ</p>";

                //ltrMail.Text += "<a href=\"mailto:" + email + "\" class=\"text-intro\">Email: <span class=\"color-red\">" + email + "</span></a>";
                ...
                //ltrEmailFT.Text += "<a href=\"mailto:" + email + "\"><span class=\"font-bold-1\">Email: </span> " + email + "</a>";
                //ltrHotlineFT.Text += "<a href=\"tel:" + hotline + "\"><span class=\"font-bold-1\">Hotline: </span> " + hotline + "</a>";


                //ltrHotline.Text = "<a href=\"tel:" + hotline + "\"><span class=\"icon-phone\"><img src=\"/App_Themes/TrungVietOrder/images/phone.png\" alt=\"\"></span><span class=\"text\">HOTLINE <br/><span class=\"text-number\">" + hotline + "</span></span></a>";


                //ltrTime.Text = " <p>" + timework + "</p>";

                ltrSocial.Text += "<li><a href=\"" + confi.Facebook + "\" target=\"_blank\"><img src=\"/App_Themes/HSG/images/icon-fb-black.png\" alt=\"\"></a></li>";
                ltrSocial.Text += "<li><a href=\"" + confi.YoutubeLink + "\" target=\"_blank\"><img src=\"/App_Themes/HSG/images/icon-ytb-black.png\" alt=\"\"></a></li>";
                //insta chính là tiktok
                ltrSocial.Text += "<li><a href=\"" + confi.Instagram + "\" target=\"_blank\"><img src=\"/App_Themes/HSG/images/icon-tiktok.png\" alt=\"\"></a></li>";

                ltrSocialFT.Text += "<li><a href=\"" + confi.Facebook + "\" target=\"_blank\"><img src=\"/App_Themes/HSG/images/icon-fb-black.png\" alt=\"\"></a></li>";
                ltrSocialFT.Text += "<li><a href=\"" + confi.YoutubeLink + "\" target=\"_blank\"><img src=\"/App_Themes/HSG/images/icon-ytb-black.png\" alt=\"\"></a></li>";
                //insta chính là tiktok
                ltrSocialFT.Text += "<li><a href=\"" + confi.Instagram + "\" target=\"_blank\"><img src=\"/App_Themes/HSG/images/icon-tiktok.png\" alt=\"\"></a></li>";
            ...
            {
                ltrLogin.Text = "<div class=\"icon ic-us\"><i class=\"fa fa-user-circle-o\" aria-hidden=\"true\"></i></div><div class=\"login-register\"><a href=\"/dang-ky\">ĐĂNG KÝ</a> <span> / </span> <a href=\"/dang-nhap\">ĐĂNG NHẬP</a></div>";
            }
        }
    }
}
<%@ Page Title="Cấu hình phí vận chuyển JP - VN" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="Tariff-TQVN.aspx.cs" Inherits="NHST.manager.Tariff_TQVN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">CẤU HÌNH PHÍ VẬN CHUYỂN JP - VN</h4>
                </div>
            </div>
    ...
    <div id="modalEditFee" class="modal modal-fixed-footer">
        <div class="modal-hd">
            ...
            <h4 class="no-margin center-align">CẤU HÌNH PHÍ VẬN CHUYỂN JP - VN</h4>
        </div>
        <div class="modal-bd">
            <div class="row">
                <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtEditWareFrom" type="text" class="validate" data-type="text-only" value="JP 1"

                        ...
                        if (kq.ToInt(0) > 0)
                        {
                            if (status == 2)
                            {
                                ...
                                if (string.IsNullOrEmpty(content))
                                    HistoryPayWalletCYNController.Insert(u.ID, u.Username, money, walletCYN, 2, 3, u.Username + " đã được nạp tiền yên vào tài khoản.",
                                ...
                                //u.Username, 0, "", "Bạn đã được admin nạp " + money + " yên vào trong tài khoản", 0,
                                //currentdate, username);                            

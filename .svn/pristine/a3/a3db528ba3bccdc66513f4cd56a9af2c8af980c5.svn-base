                                        ...
                                        <table class="table highlight tb-border ad-rp-checkout">
                                            <thead>
                                                <tr class="teal darken-4">
                                                    ...
                                                    <th class="white-text">Tổng tiền (đ)</th>
                                                    <th class="white-text">Tiền hàng </br> trên web (đ)</th>
                                                    <th class="white-text">Tiền mua thật (đ)</th>
                                                    <th class="white-text">Phí mua hàng (đ)</th>
                                                    <th class="white-text">Phí ship Nhật (đ)</th>
                                                    <th class="white-text">Phí ship </br> Nhật thật (đ)</th>
                                                    <th class="white-text">Cân nặng (kg)</th>
                                                    <th class="white-text">Phí v/c JP-VN (đ)</th>                                                      
                                                    <th class="white-text">Phí kiểm đếm (đ)</th>
                                                    <th class="white-text">Phí đóng gỗ (đ)</th>
                                                    <th class="white-text">Phí bảo hiểm (đ)</th>       
                                                    <th class="white-text">Phí lưu kho (đ)</th>
                                                    <th class="white-text">Lợi nhuận (đ)</th>
                                                    <th class="white-text">Ngày đặt</th>
                                                    <th class="white-text">Ngày về kho VN</th>
                                                    <th class="white-text">Ngày xuất kho</th>
                                                </tr>
                                            </thead>
                                            <tbody>

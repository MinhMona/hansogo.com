        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Lịch sử yêu cầu rút yên</h4>
        ...
        <div class="row">
            ...
            <div class="detail-fixed  col s12 m5 l5 xl4 section" id="donate-detail">
                <div class="rp-detail card-panel row">
                    <div class="col s12">
                        <div class="page-title">
                            <h5>Yêu cầu rút yên #<asp:Label runat="server" ID="lbID"></asp:Label></h5>
                    ...
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <label for="rp_vnd">Số tiền rút (¥-Yên)</label>
                            </div>
                            <div class="input-field col s12">

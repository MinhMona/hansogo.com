            ...
            if (!string.IsNullOrEmpty(mvd))
            {
                ...
                if (smallpackage != null)
                {
                    ...
                    else if (smallpackage.Status == 1)
                    {
                        ...
                        html += "</div>";
                        html += "<div class=\"track-item\">";
                        html += "<p><strong>Trạng thái:</strong><span>Mã vận đơn vừa được tạo - chưa về kho JP</span></p>";
                        html += "</div>";
                        html += "<div class=\"track-item\">";
                    ...
                    else if (smallpackage.Status == 2)
                    {
                        ...
                        else
                        {
                            ...
                            html += "</div>";
                            html += "<div class=\"track-item\">";
                            html += "<p><strong>Trạng thái:</strong><span>Đã về kho JP</span></p>";
                            html += "</div>";
                            html += "<div class=\"track-item\">";

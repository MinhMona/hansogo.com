                    ...
                    if (setNoti != null)
                    {
                                ...
                                foreach (var admin in admins)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGmail_new( admin.Email,
                                            "Thông báo tại HANSOGO.", "Có yêu cầu nạp tiền mới từ tài khoản " + u.Username + " với số tiền " + Convert.ToDouble(pAmount.Value) + "", "");
                                    }
                                    catch { }
                                }
                            }
                        ...
                        if (setNoti.IsSendEmailUser == true)
                        {
                            try
                            {
                                ...
                                html.Append("<tr>");
                                html.Append("<td style=\"padding: 10px; background-color: #fca777; color: #fff; text-align: center\"><strong><p>KÍNH CHÀO QUÝ KHÁCH!</p><p><a style=\"text-decoration: none\" href=\"https://HANSOGO.COM/\" target=\"_blank\"><strong>HANSOGO.COM<strong></a> THÔNG BÁO NẠP VÍ THÀNH CÔNG</p></strong></td>");
                                html.Append("</tr>");
                                html.Append("<tr>");
                                ...
                                html.Append("</tr>");
                                html.Append("<tr>");
                                html.Append("<td><a style=\"text-decoration: none\" href=\"https://HANSOGO.COM/\" target=\"_blank\"><strong>HANSOGO.COM<strong></a> chân thành cảm ơn!</td>");
                                html.Append("</tr>");
                                html.Append("<tr>");
                                html.Append("<td>==============================</td>");
                                html.Append("<tr>");
                                ...
                                //"HANSOGO.COM THÔNG BÁO NẠP VÍ THÀNH CÔNG",
                                ...
                                PJUtils.SendMailGmail_new( u.Email,
                                                        "HANSOGO.COM THÔNG BÁO GỬI YÊU CẦU NẠP VÍ THÀNH CÔNG",

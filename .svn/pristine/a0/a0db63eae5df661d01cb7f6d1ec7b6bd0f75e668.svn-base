...
namespace NHST.manager
{
    public partial class UserInfo : System.Web.UI.Page
    {
        ...
        public void LoadSaler()
        {
            ...
            ddlWareHouseTQ.Items.Insert(0, "Chọn kho JP");
            if (khotq.Count > 0)
            {
            ...
            if (!string.IsNullOrEmpty(pass))
            {
                ...
                if (!string.IsNullOrEmpty(confirmpass))
                {
                    if (confirmpass == pass)
                    {
                        ...
                        txtAddress.Text.Trim(), DateTime.ParseExact(txtBirthday.Text, "dd/MM/yyyy HH:mm", null), ddlGender.SelectedValue.ToInt(), "", "", currentDate, username_current);
                        if (r == "1" && rp == "1")
                        {

                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 l3">
                                            <asp:DropDownList runat="server" ID="ddlType">
                                                ...
                                                <asp:ListItem Value="5">Mã đơn hàng</asp:ListItem>
    ...
    <script type="text/javascript">
                ...
                success: function (msg) {
                    ...
                    if (data != "null") {
                        if (data != "notpermission") {
                           // location.reload();
                            alertify.success('Gán nhân viên đặt hàng thành công');
                        }
                        else {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (data != "null") {
                        if (data != "notpermission") {
                           // location.reload();
                            alertify.success('Gán nhân viên kinh doanh thành công');
                        }
                        else {
                            alert('Bạn không có quyền');
                        }
        ...
        $(".madonhang").change(function () {
           ...
           // alert(id);
            ...
            $.ajax({
                type: "POST",
                url: "/manager/OrderList.aspx/UpdateOrderCode",
                data: "{OrderID:'" + id + "',Code:'" + text + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    var data = msg.d;
                    if (data != "null") {
                        if (data != "notpermission") {
                            ...
                            alertify.success('Gán mã đơn hàng thành công');

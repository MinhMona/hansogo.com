<%@ Page Title="Lịch sử nạp yên" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="RequestRechargeCYN.aspx.cs" Inherits="NHST.manager.RequestRechargeCYN" %>
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Lịch sử nạp yên</h4>
        ...
        <div class="row">
            ...
            <div class="detail-fixed  col s12 m5 l5 xl4 section" id="donate-detail">
                <div class="rp-detail card-panel row">
                    <div class="col s12">
                        <div class="page-title">
                            <h5>Yêu cầu nạp yên #<asp:Label runat="server" ID="lbID"></asp:Label></h5>
